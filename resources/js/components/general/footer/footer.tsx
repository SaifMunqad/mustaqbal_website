            ...
            <div className={'mb-3'}>
                <footer className="rounded-2xl bg-gray-100 px-4 py-2 shadow-md backdrop-blur-lg backdrop-saturate-150 lg:px-8 lg:py-3 dark:bg-gray-800">
                    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                        <div className="block md:flex md:justify-between">
                            ...
                            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 sm:gap-6 md:grid-cols-3">
                                <div>
                                    ...
                                    <ul className="font-medium text-gray-600 dark:text-gray-300">
                                        <li className="mb-4">
                                            <a
                                                href="https://flowbite.com/"
                        ...
                        <hr className="my-6 border-gray-200 sm:mx-auto lg:my-8 dark:border-gray-800" />
                        <div className="sm:flex sm:items-center sm:justify-between">
                            ...
                            <div className="mt-4 flex sm:mt-0 sm:justify-center">
                                ...
                                <a
                                    href="#"
                                    className="ms-5 text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white"
                                >
                                    <svg
                                        className="h-4 w-4"
                                        aria-hidden="true"
